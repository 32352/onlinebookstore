    ...
    return (
        <div className="top-bar">
            <div className="left-topbar-container">
                ...
                <Link to="/">
                    <h2 className="top-bar-brand-name" style={{ color: 'green' }}>ONLINE BOOK STORE</h2>
                </Link>
                {
            ...
            <div className="right-topbar-container">
                {
                    ...
                    ? (
                        <button onClick={logoutUser} className="navbar-login-btn solid-primary-btn" style={{ backgroundColor: 'green' }}>Logout</button>
                    )
                    : (
                        <Link to="/login">
                            <button className="navbar-login-btn solid-primary-btn" style={{ backgroundColor: 'green' }}>Login</button>
                        </Link>
                    )
                }
                <Link to="/shop">
                    <button className="icon-btn" style={{ backgroundColor: 'green' }}>
                        <div>
                            <BsShopWindow style={{ color: 'white' }} />
                        </div>
                    </button>
                </Link>
                <Link to="/wishlist">
                    <button className="icon-btn" style={{ backgroundColor: 'green' }}>
                        <div className="icon-count-badge">
                            <i className="fa fa-heart-o fa-x" aria-hidden="true" style={{ color: 'white' }} ></i>
                            {
                ...
                <Link to="/cart">
                    <button className="icon-btn" style={{ backgroundColor: 'green' }}>
                        <div className="icon-count-badge">
                            <i className="fa fa-shopping-cart fa-x" aria-hidden="true" style={{ color: 'white' }} ></i>
                            {
                                userCart.length!==0
